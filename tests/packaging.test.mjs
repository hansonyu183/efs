...
test('publishable package manifests export built dist entries instead of src entries', () => {
 ...
 assert.equal(vuePkg.exports['./components/*'], './dist/components/*')
 assert.equal(vuePkg.exports['./shared/*'].default, './dist/shared/*.js')
 assert.equal(vuePkg.exports['./shared/*'].types, './dist/shared/*.d.ts')
 assert.equal(vuePkg.exports['./controller/*'].default, './dist/controller/*.js')
 assert.equal(vuePkg.exports['./controller/*'].types, './dist/controller/*.d.ts')
