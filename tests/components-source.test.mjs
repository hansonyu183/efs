...
test('DynamicPageRenderer exposes runtime page aliasing and shell plan contract', () => {
  const source = read(path.join(repoRoot, 'packages/vue/src/runtime/DynamicPageRenderer.ts'))
  assert.match(source, /const pageTypeAliases/)
  assert.match(source, /list: 'query-list'/)
  assert.match(source, /form: 'form-page'/)
  assert.match(source, /detail: 'readonly-detail'/)
  assert.match(source, /report: 'report-page'/)
  assert.match(source, /export function renderDynamicPage/)
  assert.match(source, /layoutPlan/)
  assert.match(source, /shell: \{/)
  assert.match(source, /component: 'EntityListTable'/)
  assert.match(source, /component: 'FormShell'/)
  assert.match(source, /component: 'DetailShell'/)
  assert.match(source, /component: 'ReportShell'/)
})
