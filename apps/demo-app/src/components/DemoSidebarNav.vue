...
import type { FlatMenuNode, SidebarMenuTreeNode } from '../../../../packages/vue/src/runtime/NavigationMenu'
import { buildSidebarMenuTree } from '../../../../packages/vue/src/runtime/NavigationMenu'
