...
最低要求：
- 提供统一未认证背景与居中布局
- 支持标题、副标题、header slot、alerts slot
- 支持内容宽度控制
- 小屏下保持可读与可操作
...
最低要求：
- 提供 sidebar / header / content / alerts 结构
- 支持 brand slot、sidebar slot、toolbar slot、header-title slot
- 支持标题、副标题、组织信息展示
- 支持响应式布局折叠为单列
- 允许业务应用将菜单、组织切换、主题切换、全局告警等接入同一布局骨架
