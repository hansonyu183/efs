...
export function normalizeEfsPath(path) {
...
export function useEfsNavigation(options) {
...
function resolveInitialPath(initialPath, loginPath) {
    if (typeof window !== 'undefined' && window.location?.pathname) {
        return normalizeEfsPath(window.location.pathname);
    }
    if (initialPath)
        return normalizeEfsPath(initialPath);
    return loginPath;
}
